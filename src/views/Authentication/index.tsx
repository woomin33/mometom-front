...
export default function Authentication(){
            ...
            <div className='auth-card'>
                <div className='auth-card-box'>
                    ...
                    <div className='auth-card-bottom'>
                        ...
                        <div className='auth-button black-large-full-button' onClick={onSignInButtonClickHandler}>{'로그인'}</div>
    ...
    const SignUpCard = () => {
        ...
        //          event handler: 개인 정보 동의 체크 클릭 이벤트 처리          //
        ...
        return (
            <div className='auth-card'>
                <div className='auth-card-box'>
                    ...
                    <div className='auth-card-bottom'>
                        {page === 1 &&(
                        <div className='auth-button black-large-full-button' onClick={onNextButtonClickHandler}>{'다음 단계'}</div>
                        )}
                        {page === 2 && (
                        <>
                        ...
                        <div className='auth-button black-large-full-button' onClick={onSignUpButtonClickHandler}>{'회원가입'}</div>
                        </>
                        )}
                        <div className='auth-description-box'>
                ...
                {/* <div className='auth-jumbotron-box'>
                    <div className='auth-jumbotron-contents'>
                        ...
                        <div className="auth-jumbotron-text-box">
                            <div className='auth-jumbotron-text'>{'woomin'}</div>
                            <div className='auth-jumbotron-text'>{view === 'sign-in' ? '로그인페이지 입니다.' : '회원가입페이지 입니다.'}</div>
                        </div>
                    </div>
                </div> */}
