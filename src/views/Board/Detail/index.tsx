...
export default function BoardDetail(){
    ...
    const BoardDetailTop = () => {
        ...
        const handleOutsideClose = (e: {target: any}) => {
            if(showMore && (!showMoreRef.current?.contains(e.target)&& !e.target.classList.contains('more-icon'))) setShowMore(false);
        };
            ...
            <div id='board-detail-top'>
                <div className='board-detail-top-header'>
                    ...
                    <div className='board-detail-top-sub-box'>
                        ...
                        {showMore &&
                        <div ref={showMoreRef} className='board-detail-more-box'>
                ...
                <div className='board-detail-top-main'>
                    ...
                    {board.boardVideoList.map(video => <video key={video} className='board-detail-main-image' src={video} controls />)}
